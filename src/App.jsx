  ...
  return (
    <>
      <div className="main-box">
        ...
        <div className="lower">
          <h2 className="profile-name">John Andre B. Gomez</h2>
          <h3 className="tag">Front-end Developer</h3>
          ...
          <div className="social-rate">
            <div className="rate-item">
              <img src={heart_icon} alt="heart" /> <span>60k</span>
            </div>
            <p>|</p>
            <div className="rate-item">
              <img src={comment_icon} alt="comment" /> <span>20k</span>
            </div>
            <p>|</p>
            <div className="rate-item">
              <img src={share_icon} alt="share" /> <span>12k</span>
            </div>
          </div>
        </div>
      </div>
